...
class IntStackList {
	...
	//--- 생성자(constructor) ---//
	public IntStackList(int maxlen) {
		stk = new ArrayList<>();
		capacity = maxlen;
		ptr = 0;
	}
	...
	public void clear() throws EmptyIntStackException {
		 ...
		 */
		if (isEmpty()) // 스택이 빔
			throw new EmptyIntStackException("clear: Stack is already empty");
...
public class 스택_정수리스트 {

	public static void main(String[] args) {
		Scanner stdIn = new Scanner(System.in);
		IntStackList s = new IntStackList(4); // 최대 64 개를 푸시할 수 있는 스택
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(x);
				} catch (IntStackList.OverflowIntStackException e) {
			...
			case 2: // 팝
				...
				} catch (IntStackList.EmptyIntStackException e) {
